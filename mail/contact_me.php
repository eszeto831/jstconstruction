...
$to = 'peter@jstconstruction.net'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
...
$email_subject = "JST Construction";
